---
title: 'Density of packings'
type: "blueprint-chapter"
tags:
  - "blueprint"
---

The definition of density given in sec:sphere-packings is inconvenient to work with, especially when our packing is a structured one, such as a periodic/lattice packing. This section fixes this problem.
...
## Lemma: sp-finite-density-bound {#lemma:sp-finite-density-bound lean="SpherePacking.finiteDensity_le, SpherePacking.finiteDensity_ge" uses="SpherePacking.finiteDensity"}
...
## Lemma: lattice-points-bound {#lemma:lattice-points-bound lean="PeriodicSpherePacking.aux2_ge', PeriodicSpherePacking.aux2_le'"}
...
To link [sp-finite-density-bound](#lemma:sp-finite-density-bound) and [lattice-points-bound](#lemma:lattice-points-bound), we need a lemma relating $|\Lambda \cap \mathcal{B}|$ with $|X \cap \mathcal{B}|$, which is what the following lemma does:

## Lemma: periodic-points-bounds {#lemma:periodic-points-bounds lean="PeriodicSpherePacking.aux_ge, PeriodicSpherePacking.aux_le"}
...
## Lemma: volume-ball-ratio-limit {#lemma:volume-ball-ratio-limit lean="volume_ball_ratio_tendsto_nhds_one''"}
...
## Theorem: psp-density {#theorem:psp-density lean="PeriodicSpherePacking.density_eq" uses="SpherePacking.density"}
...
### Proof {uses="lemma:sp-finite-density-bound, lemma:lattice-points-bound, lemma:periodic-points-bounds, lemma:volume-ball-ratio-limit"}

Fix any fundamental domain $\mathcal{D}$ (induced by any basis) of the lattice $\Lambda$. Combining [sp-finite-density-bound](#lemma:sp-finite-density-bound), [lattice-points-bound](#lemma:lattice-points-bound) and [periodic-points-bounds](#lemma:periodic-points-bounds), we get the following inequality for the _finite_ density:
...
$$
  ...
  Taking limit on both sides as $R \to \infty$ and apply the Sandwich theorem and [volume-ball-ratio-limit](#lemma:volume-ball-ratio-limit), we get
